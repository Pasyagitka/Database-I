use master;
CREATE DATABASE TMPZ_UNIVER;

use TMPZ_UNIVER;

CREATE TABLE FACULTY (
  FACULTY_SHORTNAME char(10) CONSTRAINT FACULTY_PK primary key,
  FACULTY_NAME varchar(50) default '???'
);

INSERT INTO FACULTY (FACULTY_SHORTNAME,   FACULTY_NAME )
...
CREATE TABLE PROFESSION (
  PROFESSION_SHORTNAME char(20) constraint PROFESSION_PK primary key,
  FACULTY char(10) constraint PROFESSION_FACULTY_FK foreign key references FACULTY (FACULTY_SHORTNAME),
  PROFESSION_NAME varchar(100),
  QUALIFICATION varchar(50)
);
INSERT INTO PROFESSION(FACULTY, PROFESSION_SHORTNAME, PROFESSION_NAME, QUALIFICATION)
...
CREATE TABLE PULPIT (
  PULPIT_SHORTNAME char(20) constraint PULPIT_PK primary key,
  PULPIT_NAME varchar(100),
  FACULTY char(10) constraint PULPIT_FACULTY_FK foreign key references FACULTY (FACULTY_SHORTNAME)
);

INSERT INTO PULPIT(PULPIT_SHORTNAME, PULPIT_NAME, FACULTY)
...
CREATE TABLE TEACHER (
  TEACHER_SHORTNAME char(10) constraint TEACHER_PK primary key,
  TEACHER_NAME varchar(100),
  GENDER char(1) CHECK (GENDER IN ('м', 'ж')),
  PULPIT char(20) constraint TEACHER_PULPIT_FK foreign key references PULPIT (PULPIT_SHORTNAME)
);

INSERT INTO TEACHER(TEACHER_SHORTNAME, TEACHER_NAME, GENDER, PULPIT)
...
CREATE TABLE SUBJECT (
  SUBJECT_SHORTNAME char(10) constraint SUBJECT_PK primary key,
  SUBJECT_NAME varchar(100) unique,
  PULPIT char(20) constraint SUBJECT_PULPIT_FK foreign key references PULPIT (PULPIT_SHORTNAME)
);
INSERT INTO SUBJECT(SUBJECT_SHORTNAME, SUBJECT_NAME, PULPIT)
...
CREATE TABLE AUDITORIUM_TYPE (
  AUDITORIUM_TYPE_SHORT char(10) constraint AUDITORIUM_TYPE_PK primary key,
  AUDITORIUM_TYPENAME varchar(30)
)
INSERT INTO AUDITORIUM_TYPE(AUDITORIUM_TYPE_SHORT, AUDITORIUM_TYPENAME)
...
CREATE TABLE AUDITORIUM (
  AUDITORIUM_NAME char(20) constraint AUDITORIUM_PK primary key,
  AUDITORIUM_TYPE char(10) constraint AUDITORIUM_AUDITORIUM_TYPE_FK foreign key references AUDITORIUM_TYPE(AUDITORIUM_TYPE_SHORT),
...
INSERT INTO AUDITORIUM(AUDITORIUM_NAME, AUDITORIUM_TYPE, AUDITORIUM_CAPACITY)
values
  ('206-1', 'ЛБ-К',15),
  ('301-1', 'ЛБ-К', 15),
  ('236-1', 'ЛК', 60),
...
CREATE TABLE GROUPS (
  ...
  FACULTY char(10) constraint GROUPS_FACULTY_FK foreign key references FACULTY(FACULTY_SHORTNAME),
  PROFESSION char(20) constraint GROUPS_PROFESSION_FK foreign key references PROFESSION(PROFESSION_SHORTNAME),
...
insert into STUDENT (IDGROUP, NAME, BDAY)
        values (2, 'Хартанович Екатерина Александровна', '11.03.1995'),        
			   ...
			   (2, 'Зыкова Кристина Дмитриевна',  '12.10.1995'),
			   (2, 'Шенец Екатерина Сергеевна',   '08.01.1995'),
